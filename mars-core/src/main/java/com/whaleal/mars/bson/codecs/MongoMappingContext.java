...
import com.whaleal.mars.geojson.codecs.GeoJsonCodecProvider;
...
public class MongoMappingContext {
    ...
    public MongoMappingContext( MongoDatabase database ) {
        ...
        CodecRegistry codecRegistry = fromProviders(
                new com.whaleal.mars.bson.codecs.internal.ValueCodecProvider(),
                new BsonValueCodecProvider(),
                new DBRefCodecProvider(),
                new DBObjectCodecProvider(),
                new DocumentCodecProvider(new DocumentToDBRefTransformer()),
                new IterableCodecProvider(new DocumentToDBRefTransformer()),
                new com.whaleal.mars.bson.codecs.internal.MapCodecProvider(),
