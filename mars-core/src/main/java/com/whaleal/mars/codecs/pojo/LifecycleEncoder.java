...
public class LifecycleEncoder extends EntityEncoder {
    ...
    public <T> LifecycleEncoder(MarsCodec<T> marsCodec) {
        super(marsCodec);
    }
    ...
    public void encode(BsonWriter writer, Object value, EncoderContext encoderContext) {
        ...
        MongoMappingContext mapper = getMarsCodec().getMapper();
        ...
        getMarsCodec().getRegistry().get(Document.class).encode(writer, document, encoderContext);
    }
