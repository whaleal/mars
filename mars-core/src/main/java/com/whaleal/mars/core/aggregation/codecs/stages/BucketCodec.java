...
public class BucketCodec extends StageCodec<Bucket> {
    ...
    protected void encodeStage(BsonWriter writer, Bucket value, EncoderContext encoderContext) {
        ExpressionHelper.document(writer, () -> {
            ExpressionHelper.expression(getMapper(), writer, "groupBy", value.getGroupBy(), encoderContext);
            ExpressionHelper.value(getMapper(), writer, "boundaries", value.getBoundaries(), encoderContext);
            ExpressionHelper.value(getMapper(), writer, "default", value.getDefaultValue(), encoderContext);
