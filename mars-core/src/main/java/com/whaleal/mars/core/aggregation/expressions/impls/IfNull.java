    ...
    public void encode(MongoMappingContext mapper, BsonWriter writer, EncoderContext encoderContext) {
        ExpressionHelper.document(writer, () -> {
            ExpressionHelper.array(writer, getOperation(), () -> {
                ExpressionHelper.expression(mapper, writer, target, encoderContext);
                ExpressionHelper.expression(mapper, writer, replacement, encoderContext);
                ExpressionHelper.expression(mapper, writer, document, encoderContext);
            });
        });
    }
