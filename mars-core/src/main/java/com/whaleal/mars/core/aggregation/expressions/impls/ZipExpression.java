    ...
    public void encode(MongoMappingContext mapper, BsonWriter writer, EncoderContext encoderContext) {
        ExpressionHelper.document(writer, () -> {
            ExpressionHelper.document(writer, getOperation(), () -> {
                ExpressionHelper.value(mapper, writer, "inputs", inputs, encoderContext);
                ExpressionHelper.value(mapper, writer, "useLongestLength", useLongestLength, encoderContext);
                ExpressionHelper.value(mapper, writer, "defaults", defaults, encoderContext);
            });
        });
    }
