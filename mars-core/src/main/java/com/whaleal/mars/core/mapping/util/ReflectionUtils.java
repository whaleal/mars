 ...
 */
package com.whaleal.mars.core.mapping.util;

import com.mongodb.lang.Nullable;
import com.whaleal.mars.util.Assert;
import com.whaleal.mars.util.ConcurrentReferenceHashMap;
...
public abstract class ReflectionUtils {
    ...
    public static Field[] getAllDeclaredFields(Object object) {
        ...
        if (result == null) {
            ...
            declaredFieldsCache.put(object.getClass(), (result.length == 0 ? EMPTY_FIELD_ARRAY : result));
        }
