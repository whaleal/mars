...
public class UnwindOptions implements ReadConfigurable<UnwindOptions> {
    ...
    private com.mongodb.client.model.UnwindOptions originUnwindOptions;

    public UnwindOptions() {
        originUnwindOptions = new com.mongodb.client.model.UnwindOptions();
    }

    public UnwindOptions(com.mongodb.client.model.UnwindOptions originUnwindOptions) {
    ...
    @Override
    public UnwindOptions readConcern(ReadConcern readConcern) {
        this.readConcern = readConcern;
        return this;
    }

    @Override
    public UnwindOptions readPreference(ReadPreference readPreference) {
        this.readPreference = readPreference;
        return this;
    }

    @Override
    public com.mongodb.client.model.UnwindOptions getOriginOptions() {
        if (originUnwindOptions == null) {
            originUnwindOptions = new com.mongodb.client.model.UnwindOptions();
        }
        return originUnwindOptions;
    }
}
