 ...
 * <p>
 * 相关步骤
 * ① 将需要解码的字符串处理 ，去掉末尾的 `=` 符号  YQ==
 * ②将相关字符串转为byte 先找编码表 找到每个字符对应的值 再转为bit  Y 转换为 24  011000,Q 转换为 16 010000
 * ③将bit 取后六位拼接 在 /8 位 超过部分 直接截断 。 01100001 0000
 * ④ 将值转为char  01100001 转换为 a
 * </p>
 *
 *
 * @author wh
