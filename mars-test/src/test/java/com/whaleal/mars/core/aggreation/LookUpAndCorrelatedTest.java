...
public class LookUpAndCorrelatedTest {
    ...
    public void createData(){
        String s1 = "{ \"_id\" : 1, \"student\" : \"Ann Aardvark\", sickdays: [ new Date (\"2018-05-01\"),new Date (\"2018-08-23\") ] },\n" +
                "   { \"_id\" : 2, \"student\" : \"Zoe Zebra\", sickdays: [ new Date (\"2018-02-01\"),new Date (\"2018-05-23\") ] },\n";
        List<Document> documents1 = CreateDataUtil.parseString(s1);
        mars.insert(documents1,"absences");

        String s2 = "{ \"_id\" : 1, year: 2018, name: \"New Years\", date: new Date(\"2018-01-01\") },\n" +
