...
public class ValidateTest {
    ...
    public void testForValidate(){
        ...
        Document document = mars.executeCommand("{ validate: \"document\" }");
        ...
        //全验证
        Document document1 = mars.executeCommand("{ validate: \"document\", full: true }");
        ...
        //修复验证
        Document document2 = mars.executeCommand("{ validate: \"document\", repair: true } ");
        ...
        //元数据验证
        Document document3 = mars.executeCommand("{ validate: \"document\", metadata: true } ");
